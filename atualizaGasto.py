...
class Atualiza_Gasto:
    def Atualiza_Gastos(self,ValorAReceber, ValorDesenhista, ValorImpostos, ValorContabilidade, ValorFuncionarios, ValorPapelaria, ValorFaxina, OutrosGastos, DetalhesGastos):
        ...
        cursor.execute("""
        UPDATE INTO financeiro (valorTotal, valorAReceber, valorDesenhista, valorImpostos, valorContabilidade, valorFuncionarios, valorPapelaria, valorFaxina, outrosGastos, detalhesGastos)
        VALUES (?,?,?,?,?,?,?,?,?,?)
